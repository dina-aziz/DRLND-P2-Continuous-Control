...
[image1]: singleplayer-18f6053955fdb4e6d4a4a470f20199ab.gif "Trained Agent"
...
In this environment, a double-jointed arm is trained to move to target locations. A reward of +0.1 is provided for each step that the agent's hand is in the goal location. Thus, the goal of the agent is to maintain its position at the target location for as many time steps as possible.
...
To run the jupyter notebooks locally, use the file `environment.yml` located at the root of the repository to create a conda environment by excuting the following command in Anaconda Prompt:    
...
Follow the instructions in `Continuous_Control_final.ipynb` to get started with training your own agent!  
